...
/* post/show.html.twig */
class __TwigTemplate_5787dac3e3aa18f52a8591f3736cb2bcc4aa3d9f9e1d27a5bfe69837e26bf297 extends Template
{
    private $source;
    private $macros = [];
    ...
    <img src=\"";
        // line 5
        echo twig_escape_filter($this->env, ("/uploads/" . twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 5, $this->source); })()), "image", [], "any", false, false, false, 5)), "html", null, true);
        echo "\" alt=\"\">
";
...
{% endblock %}", "post/show.html.twig", "/var/www/sites/sfcourse/templates/post/show.html.twig");
    }
}
