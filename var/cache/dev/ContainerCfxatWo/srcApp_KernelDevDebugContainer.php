...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('hdpbMMPePM', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QImxkvgPmk', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    /**
     * Gets the private '.service_locator.DC5LCk5' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_DC5LCk5Service()
    {
        return $this->privates['.service_locator.DC5LCk5'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'postRep' => ['privates', 'App\\Repository\\PostRepository', 'getPostRepositoryService', false],
        ], [
    ...
    /**
     * Gets the private '.service_locator.OINsh_L' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_OINshLService()
    {
        return $this->privates['.service_locator.OINsh_L'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\PostController::delete' => ['privates', '.service_locator.c7kbHeP', 'get_ServiceLocator_C7kbHePService', false],
            'App\\Controller\\PostController::index' => ['privates', '.service_locator.DC5LCk5', 'get_ServiceLocator_DC5LCk5Service', false],
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3XScjHyECS', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3BkwunoHe+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hPyMahL9H+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('q4u6WB-y9k', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('IFxJQ0TZVd', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder4f365 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerf0879 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties3b7fb = [
        
    ];

    public function getConnection()
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'getConnection', array(), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'getMetadataFactory', array(), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'getExpressionBuilder', array(), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'beginTransaction', array(), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'getCache', array(), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->getCache();
    }

    public function transactional($func)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'transactional', array('func' => $func), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->transactional($func);
    }

    public function commit()
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'commit', array(), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->commit();
    }

    public function rollback()
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'rollback', array(), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'getClassMetadata', array('className' => $className), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'createQuery', array('dql' => $dql), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'createNamedQuery', array('name' => $name), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'createQueryBuilder', array(), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'flush', array('entity' => $entity), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'clear', array('entityName' => $entityName), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->clear($entityName);
    }

    public function close()
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'close', array(), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->close();
    }

    public function persist($entity)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'persist', array('entity' => $entity), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'remove', array('entity' => $entity), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'refresh', array('entity' => $entity), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'detach', array('entity' => $entity), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'merge', array('entity' => $entity), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'getRepository', array('entityName' => $entityName), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'contains', array('entity' => $entity), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'getEventManager', array(), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'getConfiguration', array(), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'isOpen', array(), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'getUnitOfWork', array(), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'getProxyFactory', array(), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'initializeObject', array('obj' => $obj), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'getFilters', array(), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'isFiltersStateClean', array(), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'hasFilters', array(), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return $this->valueHolder4f365->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerf0879 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder4f365) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder4f365 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder4f365->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, '__get', ['name' => $name], $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        if (isset(self::$publicProperties3b7fb[$name])) {
            return $this->valueHolder4f365->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder4f365;
    ...
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;
    ...
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, '__isset', array('name' => $name), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;
    ...
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, '__unset', array('name' => $name), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;
    ...
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, '__clone', array(), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        $this->valueHolder4f365 = clone $this->valueHolder4f365;
    }

    public function __sleep()
    {
        $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, '__sleep', array(), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;

        return array('valueHolder4f365');
    }
    ...
    {
        $this->initializerf0879 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerf0879;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerf0879 && ($this->initializerf0879->__invoke($valueHolder4f365, $this, 'initializeProxy', array(), $this->initializerf0879) || 1) && $this->valueHolder4f365 = $valueHolder4f365;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder4f365;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder4f365;
    }
}
