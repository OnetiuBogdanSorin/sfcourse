...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderde702 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer4724b = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties31c20 = [
        
    ];

    public function getConnection()
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'getConnection', array(), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'getMetadataFactory', array(), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'getExpressionBuilder', array(), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'beginTransaction', array(), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'getCache', array(), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->getCache();
    }

    public function transactional($func)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'transactional', array('func' => $func), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->transactional($func);
    }

    public function commit()
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'commit', array(), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->commit();
    }

    public function rollback()
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'rollback', array(), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'getClassMetadata', array('className' => $className), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'createQuery', array('dql' => $dql), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'createNamedQuery', array('name' => $name), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'createQueryBuilder', array(), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'flush', array('entity' => $entity), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'clear', array('entityName' => $entityName), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->clear($entityName);
    }

    public function close()
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'close', array(), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->close();
    }

    public function persist($entity)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'persist', array('entity' => $entity), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'remove', array('entity' => $entity), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'refresh', array('entity' => $entity), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'detach', array('entity' => $entity), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'merge', array('entity' => $entity), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'getRepository', array('entityName' => $entityName), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'contains', array('entity' => $entity), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'getEventManager', array(), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'getConfiguration', array(), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'isOpen', array(), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'getUnitOfWork', array(), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'getProxyFactory', array(), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'initializeObject', array('obj' => $obj), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'getFilters', array(), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'isFiltersStateClean', array(), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'hasFilters', array(), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return $this->valueHolderde702->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer4724b = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderde702) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderde702 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderde702->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, '__get', ['name' => $name], $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        if (isset(self::$publicProperties31c20[$name])) {
            return $this->valueHolderde702->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderde702;
    ...
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;
    ...
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, '__isset', array('name' => $name), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;
    ...
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, '__unset', array('name' => $name), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;
    ...
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, '__clone', array(), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        $this->valueHolderde702 = clone $this->valueHolderde702;
    }

    public function __sleep()
    {
        $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, '__sleep', array(), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;

        return array('valueHolderde702');
    }
    ...
    {
        $this->initializer4724b = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer4724b;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer4724b && ($this->initializer4724b->__invoke($valueHolderde702, $this, 'initializeProxy', array(), $this->initializer4724b) || 1) && $this->valueHolderde702 = $valueHolderde702;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderde702;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderde702;
    }
}
